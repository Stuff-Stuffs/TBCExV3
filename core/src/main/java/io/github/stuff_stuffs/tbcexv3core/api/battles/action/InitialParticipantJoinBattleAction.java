...
public class InitialParticipantJoinBattleAction implements BattleAction {
    public static final Codec<InitialParticipantJoinBattleAction> CODEC = BattleParticipantStateBuilder.Built.codec().xmap(InitialParticipantJoinBattleAction::new, action -> action.built);
    ...
    public void apply(final BattleState state, final Tracer<ActionTrace> trace) {
        ...
        final BattleParticipantState participantState = BattleParticipantState.create(built.getUuid());
