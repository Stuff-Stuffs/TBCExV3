...
public final class CoreBattleEntityComponents {
    ...
    public static final BattleEntityComponentType<AnimationDataBattleEntityComponent> ANIMATION_DATA_BATTLE_ENTITY_COMPONENT_TYPE = BattleEntityComponentType.of(AnimationDataBattleEntityComponent.CODEC, AnimationDataBattleEntityComponent.CODEC, AnimationDataBattleEntityComponent.COMBINER, Set.of(), Set.of());
    ...
    public static void init() {
        ...
        Registry.register(BattleEntityComponentType.REGISTRY, TBCExV3Core.createId("animation_data"), ANIMATION_DATA_BATTLE_ENTITY_COMPONENT_TYPE);
    }
