...
import io.github.stuff_stuffs.tbcexv3core.impl.animation.BattleAnimationContextFactoryImpl;
...
public interface BattleAnimationContextFactory {
    ...
    BattleParticipantAnimationContext forChild(BattleParticipantHandle handle, TracerView.Node<ActionTrace> action);

    BattleSceneAnimationContext forScene(TracerView.Node<ActionTrace> action);

    static BattleAnimationContextFactory create(final BattleView battle) {
        return new BattleAnimationContextFactoryImpl(battle);
    }
}
